...
.then(response => {
    ...
    return api.sendMessage("চলে এসেছি আমি পিচ্চি হাসিব তোমাদের মাঝে🤭!", event.threadID, () => api.sendMessage({ body: `${global.config.BOTNAME} CONNECTED«\n\nAssalamualaykum☘️
<------------------------------>  
...
DEVELOPER : 𝐇𝐀𝐒𝐈𝐁𝐔𝐋 𝐈𝐒𝐋𝐀𝐌 

🟣Facebook Account Link: 

https://www.facebook.com/profile.php?id=61551913599069
